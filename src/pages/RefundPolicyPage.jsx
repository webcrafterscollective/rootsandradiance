...
const RefundPolicyPage = () => {
  ...
  const pageSlug = 'refund-and-cancellation-policy'; // Slug for your Refund and Cancellation Policy page
  ...
  // Structure similar to AboutPage.jsx
  return (
      ...
      <div className="container mx-auto px-4 sm:px-6">
        {loading && (
          <p className="text-center text-xl text-brand-foreground opacity-75 py-16">
            Loading Refund and Cancellation Policy...
          </p>
        )}
        {error && (
        ...
        {pageContent && (
          <article className="prose lg:prose-lg xl:prose-xl max-w-3xl mx-auto">
            <h1
              ...
              dangerouslySetInnerHTML={{ __html: pageContent.title?.rendered || 'Refund and Cancellation Policy' }}
            />
        ...
        {!loading && !pageContent && !error && (
          <p className="text-center text-xl text-brand-foreground opacity-75 py-16">
            The "Refund and Cancellation Policy" content is currently unavailable.
          </p>
        )}
      </div>
    </div>
